...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Resource.license'
        db.add_column('metadata_resource', 'license', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='metadata_resource_license', null=True, to=orm['metadata.CodeLicense']), keep_default=False)

        # Adding field 'LayerExt.license'
        db.add_column('metadata_layerext', 'license', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='metadata_layerext_license', null=True, to=orm['metadata.CodeLicense']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Resource.license'
        db.delete_column('metadata_resource', 'license_id')

        # Deleting field 'LayerExt.license'
        db.delete_column('metadata_layerext', 'license_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 4, 4, 13, 27, 372873)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 4, 4, 13, 27, 372747)'}),
        ...
        'metadata.layerext': {
            ...
            'md_uuid': ('django.db.models.fields.CharField', [], {'default': "'618e6b67-f0d1-4557-b23b-8b5888d5be2c'", 'max_length': '36'}),
        ...
        'metadata.resource': {
            ...
            'md_standard_name': ('django.db.models.fields.CharField', [], {'default': "'ISO19115'", 'max_length': '100'}),
            'md_uuid': ('django.db.models.fields.CharField', [], {'default': "'66a14c34-1664-418c-8516-381ef500fa3a'", 'max_length': '36'}),
            'md_version_name': ('django.db.models.fields.CharField', [], {'default': "'2003'", 'max_length': '100'}),
            ...
            'use_limitation_en': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'use_limitation_it': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'377fb5be-5030-4155-bf9f-f4382979403c'", 'max_length': '36'}),
